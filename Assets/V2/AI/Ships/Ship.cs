...
namespace EconSimV2.Assets.V2.AI.Ships
{
    public class Ship
    {
        ...
        public AIClass masterAI { get; set; }
        ...
        public Ship(Vector3 startPos, EntityManager _entityManager, int startSystem, AIClass _masterAI)
        {
