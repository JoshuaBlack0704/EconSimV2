using EconSimV2.Assets.GlobalSystems;
...
namespace EconSimV2.Assets.V2.GlobalSystems
{
    public class MainSchedual : MonoBehaviour
    {
        ...
        public static EventTicketHeapItem AddToSystemV2(float timeToExecute, int type, Ship ship = null)
        {
            ...
            em.SetComponentData(ticket, new EventTicketTimeAtWrite() { timeAtWrite = selectedTicket.timeAtWrite });
            em.SetComponentData(ticket, new EventTicketTimeAtExecute() { timeAtExecute = selectedTicket.timeAtExecute });
            em.SetComponentData(ticket, new EventTicketData() { Id = selectedTicket.Id });
...
namespace EconSimV2.Assets.GlobalSystems
{
